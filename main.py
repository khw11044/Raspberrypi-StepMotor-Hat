...
cred = credentials.Certificate('drone-detection-js-firebase-adminsdk-xxxxxxxxxxx.json')
# Initialize the app with a service account, granting admin privileges
cred = credentials.Certificate('firestore-1add2-firebase-adminsdk-7vjg4-xxxxxxxxxxxxxx.json')
